...
<h1>Depósito conta</h1>
</div>

<form id="form1" name="form1" method="post" action="salva_deposito.php">
...
<div class="container-fluid">
    ...
    <tr>
      <td height="45"><input name="Enviar" class="btn btn-primary" type="submit" id="enviar" value="Depositar dinheiro" /></td>
    </tr>
  </table>
  </div>
  </div>
